                    ...
                    <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-6" data-kt-menu="true">
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'incoming.requests' ? 'active' : '' }}" href="#sts') }}">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'incoming.documents' ? 'active' : '' }}" href="#ents') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'user-management' ? 'active' : '' }}" href="#t') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'sub-category' ? 'active' : '' }}" href="# }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() == 'venue' ? 'active' : '' }}" href="#                                       <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
